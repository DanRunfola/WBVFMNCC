...
This results in \Sexpr{proj_est_count_high} projects which have adequate matches for estimation, or \Sexpr{round(proj_est_count_high/as.numeric(analysis_proj_count),2)*100}\% of all large scale projects. 
